...
func addAuthorization(t *testing.T, request *http.Request, tokenMaker token.Maker, authorizationType string, username string, lifetime time.Duration) {
	token, payload, err := tokenMaker.CreateToken(username, lifetime)
